...
8. In Github, navigate to [carbon-design-system/carbon-polyfill](https://github.com/carbon-design-system/carbon-polyfill) and click the button that reads "Compare & pull request".
